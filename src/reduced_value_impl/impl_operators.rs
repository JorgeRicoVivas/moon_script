use crate::value_parsing::ReducedValue;
...
pub(crate) fn get_binary_operators() -> Vec<(&'static str, fn(Vec<ReducedValue>) -> Result<ReducedValue, String>)> {
    vec![
            ...
            match arithmetic_choice(arg_1, arg_2,
                ...
                Err((arg_1, arg_2)) => {
                    Ok(match (arg_1, arg_2) {
                        ...
                        (ReducedValue::String(mut string_1), ReducedValue::String(string_2)) => {
                            string_1.push_str(&*string_2);
                            ReducedValue::String(string_1)
                        }
        ...
        ("/", |mut args| {
            let (arg_2, arg_1) = (args.swap_remove(1), args.swap_remove(0));
            arithmetic_choice(arg_1, arg_2,
                              |bool_1, bool_2| Err(("Operator '/' cannot be applied between booleans".to_string())),
                              |int_1, int_2| {
